...
' Copyright (C) <!--MaxCMS 无广告播放器 (QQ:420269992)删除本条信息将终止服务.请保留!-->
...
function changecss(){
	var css1=document.getElementById("layoutcss");
	var css2=document.getElementById("homecss");
	css1.setAttribute("href","http://dm.tsdm.net/template/dy12/images/layout_dark.css");
	css2.setAttribute("href","http://dm.tsdm.net/template/dy12/images/home_dark.css");
} 

function topswitch(){
	var toppic1 = "http://wx2.sinaimg.cn/large/7044f931gy1fm5wb2cgcuj20qo023tbp.jpg";  //insert pic here
	var toppic2 = "http://wx2.sinaimg.cn/large/7044f931gy1fm5wb2cgcuj20qo023tbp.jpg";  //
	var toppic3 = "http://wx2.sinaimg.cn/large/7044f931gy1fm5wb2cgcuj20qo023tbp.jpg";
	var toppic4 = "http://wx2.sinaimg.cn/large/7044f931gy1fm5wb2cgcuj20qo023tbp.jpg";
	
	var toplink1 = "http://www.tsdm.me/forum.php?mod=viewthread&tid=859571";
	var toplink2 = "http://www.tsdm.me/forum.php?mod=viewthread&tid=859571";
	var toplink3 = "http://www.tsdm.me/forum.php?mod=viewthread&tid=859571";
	var toplink4 = "http://www.tsdm.me/forum.php?mod=viewthread&tid=859571";
	
	var targeta = document.getElementById('topban');
	var targetimg = document.getElementById('topbanimg');
...
function movePlayer4(){
	var father = document.getElementById('content_box_468_15').parentNode;
	var addnode = document.getElementById('tsdmlink_t').parentNode;
	if(typeof(father)!= 'undefined' && typeof(addnode) != 'undefined'){
		var ua = navigator.userAgent.toLowerCase();
		if(navigator.userAgent.indexOf('MSIE') != -1){
			father.insertBefore(addnode, father.lastChild);
		}else{
			father.insertBefore(addnode, father.lastChildnode);
		}
	}
}

function loadCrumb(){
	var changeTitle = document.getElementById("playtitle");
	if(typeof(changeTitle) != "undefined" && typeof(window.location.href.split("-")[2]) != "undefined"){
		changeTitle.innerHTML = changeTitle.innerHTML + " " + window.location.href.split("-")[2]+1;
	}
}